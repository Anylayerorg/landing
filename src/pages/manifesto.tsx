...
const ManifestoPage = () => {
    ...
    useEffect(() => {
        ...
        if (layoutId) {
            ...
            if (layoutIndex >= 0 && layoutIndex < 10) {
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden">
            <Head>
                ...
                <meta name="description" content="The Anylayer Manifesto: A new paradigm for capital and trust." />
            </Head>
            <SEO
                title="Anylayer Manifesto"
                description="Infrastructure for the Efficiency Age."
                image="/BG.png"
            />
