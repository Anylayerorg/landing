...
const POLICIES = [
  {
    ...
    content: (
      <div className="space-y-16">
        {/* Status Header */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-6 border-y border-black/5 text-[10px] font-mono uppercase tracking-widest text-black">
          <div><span className="text-zinc-500 block mb-1">Status</span> <span className="text-lightblueprimary">Active</span></div>
          <div><span className="text-zinc-500 block mb-1">Effective</span> Jan 17, 2026</div>
          <div><span className="text-zinc-500 block mb-1">Owner</span> Anylayer Governance</div>
          <div><span className="text-zinc-500 block mb-1">Version</span> v1.0</div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 text-sm">
            {[
              ...
              <div key={i} className="space-y-1">
                <span className="text-black font-bold block uppercase text-[10px] tracking-wider">{d.term}</span>
                <p className="text-zinc-500 leading-relaxed font-light">{d.def}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="bg-lightblueprimary/5 border border-lightblueprimary/10 p-12 rounded-[32px] space-y-8">
          ...
          <div className="space-y-6 text-zinc-600 text-base md:text-lg font-light leading-relaxed">
            <p>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm">
            {[
              ...
              <div key={i} className="space-y-1">
                <span className="text-black font-bold block uppercase text-[10px] tracking-wider">{p.term}</span>
                <p className="text-zinc-500 leading-relaxed font-light">{p.def}</p>
              </div>
            ))}
          </div>
        </section>
