...
import { ArrowRight, Layers, Box, Cpu, Zap, Shield, Globe, Users } from 'lucide-react';
    ...
    return (
        <section className="relative min-h-[85vh] flex items-center bg-[#08080C] overflow-hidden pt-32 pb-20">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-20 relative z-10 w-full">
                        ...
                        >
                            <div className="space-y-8">
                                ...
                                <p className="text-base md:text-xl text-white/40 max-w-xl leading-relaxed font-light tracking-tight">
                                    Unlock the potential of verifiable reputation. <span className="text-white/60">Anylayer bridges Identity and Reputation with ZK-Proofs to create programmable application utility across DeFi, payments, and commerce.</span>
                                </p>
                            </div>
                            ...
                            >
                                ...
                                <div className="flex items-center gap-6">
                                    {[
                                        ...
                                        { icon: <Cpu size={14} />, label: "Scalable" }
                                    ].map((item, i) => (
                ...
                >
                    {[
                        { label: "MARKET EFFICIENCY", val: "CAPITAL UNLOCKED", icon: <Layers size={14} /> },
                        { label: "DATA SOVEREIGNTY", val: "PRIVATE PROOFS", icon: <Shield size={14} /> },
                        { label: "GLOBAL ADDRESSING", val: ".ANY PAYNAMES", icon: <Globe size={14} /> },
                        { label: "REPUTATION MODEL", val: "PORTABLE TRUST", icon: <Users size={14} /> }
                    ].map((item, i) => (
                        <div key={i} className="bg-black/40 p-6 space-y-2 hover:bg-white/[0.02] transition-colors group cursor-default">
                            ...
                            <p className="text-lg font-black uppercase tracking-tight text-white/90 group-hover:text-white transition-colors">
                                {item.val}
                            </p>
                        </div>
                    ))}
